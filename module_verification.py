...
def partie_stat(g, f_json: str):
    ...
    # SOMMETS
    list_arthure = [
        {"id": "Arthur_Pendragon",   "type": "person", "name": "Arthur Pendragon",   "Alias": ["Arthur", "Le roi Arthur", "Roi légitime des Bretons", "Le roi trahi"]},
        {"id": "Uther_Pendragon",    "type": "person", "name": "Uther Pendragon",    "Alias": ["Uther", "Le roi breton Uther Pendragon", "Son père", "le père d Arthur"]},
    ...
    relations_arthur = [
        ...
        {"source": "Ygern",              "target": "Uther Pendragon",  "relation": "amant de"},
        {"source": "Uther Pendragon",    "target": "Arthur",           "relation": "père de"},
        {"source": "Arthur",             "target": "Uther Pendragon",  "relation": "fils de"},
        {"source": "Ygern",              "target": "Arthur",           "relation": "mère de"},
        {"source": "Arthur",             "target": "Ygern",            "relation": "fils de"},
        {"source": "Léodagant",          "target": "Guenièvre",        "relation": "père de"},
        {"source": "Guenièvre",          "target": "Léodagant",        "relation": "fille de"},
        {"source": "Arthur",             "target": "Guenièvre",        "relation": "époux de"},
        {"source": "Guenièvre",          "target": "Arthur",           "relation": "épouse de"},
        {"source": "Arthur",             "target": "Gauvain",          "relation": "oncle de"},
        {"source": "Gauvain",            "target": "Arthur",           "relation": "neveu de"},
        {"source": "Arthur",             "target": "Morgane",          "relation": "demi-frère de"},
        {"source": "Morgane",            "target": "Arthur",           "relation": "demi-sœur de"},
        {"source": "Arthur",             "target": "Morgause",         "relation": "demi-frère de"},
        {"source": "Morgause",           "target": "Arthur",           "relation": "demi-sœur de"},
        {"source": "Arthur",             "target": "Mordred",          "relation": "père de"},
        {"source": "Mordred",            "target": "Arthur",           "relation": "fils de"},
        {"source": "Arthur",             "target": "Mordred",          "relation": "oncle de"},
        {"source": "Mordred",            "target": "Arthur",           "relation": "neveu de"},
        ...
        {"source": "Arthur",             "target": "Camille",          "relation": "amant de"},
        {"source": "Camille",            "target": "Arthur",           "relation": "maîtresse de"},
        {"source": "Mordred",            "target": "Guenièvre",        "relation": "désire"},
        {"source": "Mordred",            "target": "Guenièvre",        "relation": "moleste"},
        {"source": "Merlin",             "target": "Arthur",           "relation": "cache"},
        {"source": "Arthur",             "target": "Merlin",           "relation": "est caché par"},
        {"source": "Merlin",             "target": "Petit noble",      "relation": "confie à"},
        {"source": "Petit noble",        "target": "Merlin",           "relation": "se voit confier"},
        {"source": "Petit noble",        "target": "Arthur",           "relation": "élève"},
        {"source": "Arthur",             "target": "Petit noble",      "relation": "a été élevé par"},
        {"source": "Arthur",             "target": "Léodagant",        "relation": "allié de"},
        {"source": "Léodagant",          "target": "Arthur",           "relation": "allié de"},
        {"source": "Arthur",             "target": "Lancelot du Lac",  "relation": "ami de"},
        {"source": "Lancelot du Lac",    "target": "Arthur",           "relation": "ami de"},
        {"source": "Lancelot du Lac",    "target": "Guenièvre",        "relation": "champion de"},
        {"source": "Lancelot du Lac",    "target": "Guenièvre",        "relation": "sauveur de"},
        {"source": "Girflet",            "target": "Arthur",           "relation": "survivant fidèle de"},
        {"source": "Arthur",             "target": "Girflet",          "relation": "a pour survivant fidèle"},
        {"source": "Barons",             "target": "Arthur",           "relation": "contestent"},
        {"source": "Arthur",             "target": "Barons",           "relation": "est contesté par"},
        ...
        {"source": "Arthur",             "target": "Claudas",          "relation": "punit"},
        {"source": "Claudas",            "target": "Arthur",           "relation": "est puni par"},
        ...
        {"source": "Arthur",             "target": "Guenièvre",        "relation": "condamne au bûcher"},
        {"source": "Guenièvre",          "target": "Arthur",           "relation": "est condamnée au bûcher par"},
        {"source": "Lancelot du Lac",    "target": "Arthur",           "relation": "combat"},
        {"source": "Arthur",             "target": "Lancelot du Lac",  "relation": "combat"},
        {"source": "Mordred",            "target": "Arthur",           "relation": "trahit"},
        {"source": "Arthur",             "target": "Mordred",          "relation": "est trahi par"},
        {"source": "Arthur",             "target": "Mordred",          "relation": "affronte"},
        {"source": "Mordred",            "target": "Arthur",           "relation": "affronte"},
        {"source": "Mordred",            "target": "Arthur",           "relation": "tue"},
    ]
